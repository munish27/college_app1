...
import 'package:clg_app/ui/students/student_logout_screen.dart';
...
class StudentAdminScreen extends StatefulWidget {
  const StudentAdminScreen({Key? key}) : super(key: key);
          ...
          Navigator.of(context).push(
            MaterialPageRoute(
              builder: (BuildContext context) => ChangeNotifierProvider.value(
                value: _provider,
                builder: (context, child) => StudentCourseListScreen(
                    studentId: MyPreference().getMyId()),
              ),
            ),
          );
          break;
                  ...
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (BuildContext context) => ChangeNotifierProvider(
                        create: (_) => StudentAdminProvider(),
                        builder: (context, child) => StudentLogoutScreen(),
                      ),
                    ),
                  );
                },
