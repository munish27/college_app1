...
class ExamClassListScreen extends StatefulWidget {
  late ExamEntity exam;
  ...
  @override
  State<ExamClassListScreen> createState() => _ExamClassListScreenState();
}

class _ExamClassListScreenState extends State<ExamClassListScreen> {
                ...
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (BuildContext context) =>
                      ...
                      value: _provider,
                      builder: (context, child) => MarkListScreen(
                        classId: classes[index].classId.toString(),
                        examName: widget.exam.exName ?? '',
                        examId: widget.exam.exId.toString(),
                      ),
                    ),
                  ),
                );
